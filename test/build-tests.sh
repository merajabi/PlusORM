...
g++ -I. -I.. -I../sqlite3.24/inc -I${GTEST_DIR}/include -g -O0 -Wall -fPIC -std=c++98 sqlight-test.cpp -o sqlight-test.out -L. -L.. -Wl,-rpath,.:.. -Wl,--start-group -lutils -lsqlite3.24 -lgtest -lpthread -ldl  -Wl,--end-group
